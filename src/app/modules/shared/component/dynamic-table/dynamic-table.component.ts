...
export class DynamicTableComponent implements OnInit {
  ...
  @Output() printHandler: EventEmitter<any> = new EventEmitter();

  @Output() printTableHandler: EventEmitter<any> = new EventEmitter();
  @Output() downloadFileHandler: EventEmitter<any> = new EventEmitter();
  ...
  printHandlerEmit(item: any): void {
    this.printHandler?.emit(item)
  }
  printTableHandlerEmit(): void {
    this.printTableHandler?.emit(this.tableData)
  }
  downloadFileHandlerEmit(): void {
    this.downloadFileHandler?.emit()
  }
      ...
      this.filtersTable['evaluation_time'] = [
        {
          ...
          matchMode: this.operator?.operatorEnd ? this.operator?.operatorEnd : 'timeIs',
          operator: 'and', type: 'time'
        }];
    }
